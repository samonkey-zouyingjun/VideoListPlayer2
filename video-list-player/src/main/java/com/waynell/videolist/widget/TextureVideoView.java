...
public class TextureVideoView extends TextureView
    ...
    public void setIMediaPlayerCallback(IMediaPlayerCallback IMediaPlayerCallback) {
        mIMediaPlayerCallback = IMediaPlayerCallback;
...
//            am.abandonAudioFocus(null);
    ...
    private void openVideo() {
        ...
        try {
            ...
            mIMediaPlayer.setDataSource(mContext, mUri);
            ...
            if (mIMediaPlayerCallback != null) {
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        if(mIMediaPlayerCallback != null) {
                            mIMediaPlayerCallback.onError(mIMediaPlayer, IMediaPlayer.MEDIA_ERROR_UNKNOWN, 0);
                        }
                    }
                });
            }
    ...
    public void onCompletion(final IMediaPlayer mp) {
        ...
        if (mIMediaPlayerCallback != null) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if(mIMediaPlayerCallback != null) {
                        mIMediaPlayerCallback.onCompletion(mp);
                    }
                }
            });
        }
    ...
    public boolean onError(final IMediaPlayer mp, final int what, final int extra) {
        ...
        if (mIMediaPlayerCallback != null) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if(mIMediaPlayerCallback != null) {
                        mIMediaPlayerCallback.onError(mp, what, extra);
                    }
                }
            });
        }
    ...
    public void onPrepared(final IMediaPlayer mp) {
        ...
        if (mIMediaPlayerCallback != null) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if(mIMediaPlayerCallback != null) {
                        mIMediaPlayerCallback.onPrepared(mp);
                    }
                }
            });
        }
    ...
    @Override
    public void onVideoSizeChanged(final IMediaPlayer mp, final int width, final int height, int sar_num, int sar_den) {
        ...
        if (mIMediaPlayerCallback != null) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if(mIMediaPlayerCallback != null) {
                        mIMediaPlayerCallback.onVideoSizeChanged(mp, width, height);
                    }
                }
            });
        }
    ...
    public void onBufferingUpdate(final IMediaPlayer mp, final int percent) {
        if (mIMediaPlayerCallback != null) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if(mIMediaPlayerCallback != null) {
                        mIMediaPlayerCallback.onBufferingUpdate(mp, percent);
                    }
                }
            });
        }
    ...
    public boolean onInfo(final IMediaPlayer mp, final int what, final int extra) {
        if (mIMediaPlayerCallback != null) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if(mIMediaPlayerCallback != null) {
                        mIMediaPlayerCallback.onInfo(mp, what, extra);
                    }
                }
            });
        }
